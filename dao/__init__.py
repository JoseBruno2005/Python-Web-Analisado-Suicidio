...
def conectardbrender():
    con = psycopg2.connect(
        host='dpg-coa3h98cmk4c73e9as7g-a.oregon-postgres.render.com',
        database='bd_suicidio',
        user='bd_suicidio_user',
        password='YeUTn52uuMFtCmquDaJSyYaEC3KpKNgV'
    )
